...
- **Admin interface with Jinja2 templates** (9 pages: dashboard, nominal rolls, deployments, deferments, users, CSV upload, settings, audit, plus deployment-personnel sub-view)
